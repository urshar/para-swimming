...
<flux:field>
    <flux:label>Wettkampfjahr<span class="text-red-500 dark:text-red-400 ms-1">*</span></flux:label>
...
<div class="grid grid-cols-2 gap-4 pt-2 border-t border-zinc-100 dark:border-zinc-700">
    <flux:field>
        ...
        <flux:date-picker type="input" locale="de-AT" selectable-header name="qualification_period_start"
    ...
    <flux:field>
        ...
        <flux:date-picker type="input" locale="de-AT" selectable-header name="qualification_period_end"
